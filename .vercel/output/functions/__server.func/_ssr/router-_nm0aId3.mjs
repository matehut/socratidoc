...
//#region node_modules/.nitro/vite/services/ssr/assets/router-_nm0aId3.js
var router__nm0aId3_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BXSfMk0h.css";
var APP_NAME = "SocraticPDF";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Suba um PDF e estude pelo método socrático: o guia mede seu nível e pergunta, em vez de resumir."
			},
			{
				name: "theme-color",
				content: "#0e0d0b"
...
var $$splitComponentImporter = () => import("./routes-BCkPiyxx.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router__nm0aId3_exports as t };
